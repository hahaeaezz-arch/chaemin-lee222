...
# 과적합을 유발하는 편명(flight)과 불필요한 인덱스 삭제
columns_to_drop = []
...
# 오류가 있던 season(성수기/비수기) 로직은 생성하지 않고 완전히 삭제함
...
# ② 예약 시점 구간 변수 생성 (-1부터 시작하여 0일 데이터 손실 방지)
...
# 2. 숫자로 변환 (Encoding)
# =====================================================================
# [피드백 2번 반영] 기계학습을 위해 개별 인코딩 대신 모든 문자열 데이터를 한 번에 인코딩
# 기존의 class, stops 개별 매핑 코드를 삭제하고 get_dummies로 통합 처리
